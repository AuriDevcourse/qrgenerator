/* app.js: UI for QR Generator. Encoding and rendering live in qr-render.js. */
(function () {
  'use strict';
  ...
  // These four keys predate the rename to QR Generator. They are internal and
  // hold saved styles, recents and the theme, so renaming them would quietly
  // discard someone's work for no benefit.
  ...
  function openPrintSheet(items) {
    ...
    var doc = '<!doctype html><html><head><meta charset="utf-8">' +
      '<title>QR Generator print sheet</title><style>' + css + '</style></head><body>' +
